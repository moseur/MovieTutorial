...
declare namespace MovieTutorial.MovieDB {
    ...
    namespace GenreRow {
        ...
        const deletePermission = "MovieDB:Genre:Delete";
        const insertPermission = "MovieDB:Genre:Insert";
        const readPermission = "MovieDB:Genre:Read";
        const updatePermission = "MovieDB:Genre:Update";
        const enum Fields {
            GenreId = "GenreId",
            Name = "Name"
        }
...
declare namespace MovieTutorial.MovieDB {
    ...
    namespace MovieCastRow {
        ...
        const deletePermission = "MovieDB:MovieCast:Delete";
        const insertPermission = "MovieDB:MovieCast:Insert";
        const readPermission = "MovieDB:MovieCast:Read";
        const updatePermission = "MovieDB:MovieCast:Update";
        const enum Fields {
...
declare namespace MovieTutorial.MovieDB {
    ...
    namespace MovieGenresRow {
        ...
        const deletePermission = "MovieDB:MovieGenres:Delete";
        const insertPermission = "MovieDB:MovieGenres:Insert";
        const readPermission = "MovieDB:MovieGenres:Read";
        const updatePermission = "MovieDB:MovieGenres:Update";
        const enum Fields {
...
declare namespace MovieTutorial.MovieDB {
    ...
    namespace MovieRow {
        ...
        const lookupKey = "MovieDB.Movie";
        function getLookup(): Q.Lookup<MovieRow>;
        const deletePermission = "MovieDB:Movie:Delete";
        const insertPermission = "MovieDB:Movie:Insert";
        const readPermission = "MovieDB:Movie:Read";
        const updatePermission = "MovieDB:Movie:Update";
        const enum Fields {
            CastList = "CastList",
            MovieId = "MovieId",
            Title = "Title",
...
declare namespace MovieTutorial.MovieDB {
    ...
    namespace PersonRow {
        ...
        const deletePermission = "MovieDB:Person:Delete";
        const insertPermission = "MovieDB:Person:Insert";
        const readPermission = "MovieDB:Person:Read";
        const updatePermission = "MovieDB:Person:Update";
        const enum Fields {
            PersonId = "PersonId",
            FirstName = "FirstName",
            Lastname = "Lastname",
...
declare namespace MovieTutorial.Web.Migrations.DefaultDB {
    enum MovieKind {
        Film = 1,
        TvSeries = 2,
        MiniSeries = 3
