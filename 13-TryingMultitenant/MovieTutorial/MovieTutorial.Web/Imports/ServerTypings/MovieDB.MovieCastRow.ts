namespace MovieTutorial.MovieDB {
    ...
    export namespace MovieCastRow {
        ...
        export const deletePermission = 'MovieDB:MovieCast:Delete';
        export const insertPermission = 'MovieDB:MovieCast:Insert';
        export const readPermission = 'MovieDB:MovieCast:Read';
        export const updatePermission = 'MovieDB:MovieCast:Update';
